...
/**
 * @brief Dynamically duplicates given string, to a null terminated ending.
 * 
 * @param src The c-string to duplicate
*/
char* strdup(const char* src);

/**
 * @brief Prints a KV pair (author:songFreq) from a authorDict.
 * 
 * @param data The KVPair to print out.
*/
void printAuthorFreq(void *data);

/**
 * @brief Prints a KV pair (word:wordFreq) from a wordDict.
 * 
 * @param data The KVPair to print out.
*/
